-- Tennix Shop — Esquema de base de datos (tienda de zapatos)
-- Versión lista para importar en Hostinger vía phpMyAdmin.
-- La base ya existe en Hostinger como u100924480_tennixshop, así que no se
-- crea ni se selecciona una base: se importa directo sobre la que phpMyAdmin
-- ya tiene seleccionada/abierta.
--
-- (Generado a partir de database/schema.sql, quitando CREATE DATABASE / USE)
